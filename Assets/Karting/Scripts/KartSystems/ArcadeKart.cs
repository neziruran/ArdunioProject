...
namespace KartGame.KartSystems
{
    public class ArcadeKart : MonoBehaviour
    {
        ...
        private ArdunioScript ardunioScript;
        ...
        void Awake()
        {
            ardunioScript = GetComponent<ArdunioScript>();
        ...
        void MoveVehicle(bool accelerate, bool brake, float turnInput)
        {
            ...
            float turningPower = IsDrifting ? m_DriftTurningPower : ardunioScript.directionInput * m_FinalStats.Steer;
            Quaternion turnAngle = Quaternion.AngleAxis(turningPower, transform.up);
            Vector3 fwd = turnAngle * transform.forward;
            Vector3 movement = fwd * finalAcceleration * ((m_HasCollision || GroundPercent > 0.0f) ? 1.0f : 0.0f);
